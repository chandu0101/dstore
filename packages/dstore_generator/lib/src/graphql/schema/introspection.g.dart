...
IntrospectionQuery _$IntrospectionQueryFromJson(Map<String, dynamic> json) =>
    IntrospectionQuery()
      ..g__schema = IntrospectionSchema.fromJson(
          json['__schema'] as Map<String, dynamic>);
...
IntrospectionSchema _$IntrospectionSchemaFromJson(Map<String, dynamic> json) =>
    IntrospectionSchema()
      ...
      ..directives = (json['directives'] as List<dynamic>)
          .map(
              (e) => IntrospectionDirective.fromJson(e as Map<String, dynamic>))
          .toList();

IntrospectionNamedTypeRef _$IntrospectionNamedTypeRefFromJson(
        Map<String, dynamic> json) =>
    IntrospectionNamedTypeRef()..name = json['name'] as String;

IntrospectionType _$IntrospectionTypeFromJson(Map<String, dynamic> json) =>
    IntrospectionType()
      ..kind = $enumDecode(_$IntrospectionTypeKindEnumMap, json['kind'])
      ...
      ..inputFields = (json['inputFields'] as List<dynamic>?)
          ?.map((e) =>
              IntrospectionInputValue.fromJson(e as Map<String, dynamic>))
          .toList()
      ...
      ..enumValues = (json['enumValues'] as List<dynamic>?)
          ?.map(
              (e) => IntrospectionEnumValue.fromJson(e as Map<String, dynamic>))
          .toList()
...
IntrospectionField _$IntrospectionFieldFromJson(Map<String, dynamic> json) =>
    IntrospectionField()
      ...
      ..args = (json['args'] as List<dynamic>)
          ...
          .toList()
      ..type =
          IntrospectionTypeRef.fromJson(json['type'] as Map<String, dynamic>)
...
IntrospectionTypeRef _$IntrospectionTypeRefFromJson(
        Map<String, dynamic> json) =>
    IntrospectionTypeRef()
      ..kind = $enumDecode(_$IntrospectionTypeRefKindEnumMap, json['kind'])
      ..name = json['name'] as String?
      ..ofType = json['ofType'] == null
          ? null
          : IntrospectionTypeRef.fromJson(
              json['ofType'] as Map<String, dynamic>);
...
IntrospectionDirective _$IntrospectionDirectiveFromJson(
    ...
    IntrospectionDirective()
      ...
      ..locations = (json['locations'] as List<dynamic>)
          .map((e) => $enumDecode(_$DirectiveLocationEnumEnumMap, e))
          .toList();
